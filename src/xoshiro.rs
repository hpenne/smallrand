...
impl Xoshiro256pp {
    ...
    /// ```
    /// use smallrand::Rng;
    /// let mut rng = smallrand::Xoshiro256pp::from_device(&mut smallrand::SplitMix::new(0x12345678));
    /// let random_value : u32 = rng.random();
    /// ```
    #[must_use]
...
mod tests {
    ...
    impl crate::EntropySource for DummyDevice {
    ...
    fn test_xoshiro_from_seed() {
        // These test vectors match the values generated by the `rand` crate:
        let mut rng = Xoshiro256pp::from_device(&mut SplitMix::new(0u64));
        assert_eq!(
            vec![
                5987356902031041503,
                7051070477665621255,
